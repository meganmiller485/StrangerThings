    ...
    return(
        <div id="form">
            <form onSubmit={submitHandler}>
                ...
                <input value={username} type={"text"} onChange={(event)=>{setUsername(event.target.value)}} placeholder="username" ></input>
                <label htmlFor="Password">Password: </label>
                <input value={password} type={"password"} onChange={(event)=>{setPassword(event.target.value)}} placeholder="password"></input>
